...
<script>
    ...
    var del=confirm("éte vous sur de supprimer ce compte?");
    if (del==true){
       }else{
        }
    return del;
...
if(isset($IdCom) && isset($login) && isset($pass) 
	&& !empty($IdCom) && !empty($login) && !empty($pass) ) {
		
$req = "update compte set login = '".$login."', pass = '".$pass."' where id_compte='".$IdCom."'";
...
<h2 class="title">Modifier compte</h2>
  ...
  <tr><td></td></tr><tr><td></td></tr><tr><td></td></tr>	
	<tr><td colspan=2 align="center"><input type="submit" name="submit" value="Modifier" onClick=" return updatetconfig()">
       
   <input type="submit" onClick="document.location='listecompte.php';" value="Retour"></td></tr>
	<?php if(strlen($err)) {?>
