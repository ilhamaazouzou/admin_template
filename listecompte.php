...
<link rel="STYLESHEET" type="text/css" href="css/compte_liste.css">
<link rel="STYLESHEET" type="text/css" href="css/boutton.css">

<center>
	<h2 class="title">Comptes des utilisateurs</h2>
	
<?php
	
$req = "select id_compte,login,pass,nom_role from compte c 
		inner join role r on r.id_role=c.id_role 
		order by nom_role,login,pass";
...
?>
	...
	<tr><th width="100">Nom</th><th width="100">Pr&eacute;nom</th><th width="100">Login</th><th width="300">Modifier</th><th width="120">Supprimer</th>
		</tr>
	<?php 
	...
	<?php if( haveDroit(2) && $tab[$i][0] != 1 ) {?>
	<a href="modification_comptes.php?id=<?php echo $tab[$i][0]; ?>" title="Modifier"><img src="./image/b_edit.png" /></a>
	<?php
		}else{
	?>
	<img src="./image/b_editDisabled.png" />
	<?php
		}
	?>
	</td>
	...
	<td align="center" style="width: 30px">
	<?php if(  $tab[$i][0] != 1 && $tab[$i][0] != IdCompte()) {?>
	<a href="suppression_comptes.php?id=<?php echo $tab[$i][0]; ?>" title="Supprimer"><img src="./image/b_drop.png" /></a>
	<?php
		}else{
	?>
	<img src="./image/b_dropDisabled.png" />
	<?php
		}
	?>
	</td>
...
?>
 ...
 <a href="ajout_compte_utilisateur.php"> <input type="submit" name="submit" value="Ajouter"></a><?php }?>
 <input type="submit" onClick="document.location='default.php';" value="Retour"></button>
	</center>
