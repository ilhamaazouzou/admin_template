...
if(isset($login) &&isset($pass) 
		...
		$req = "insert into compte values('', '".$login."', '".$pass."',1)";
		$r = requete_execute($req,$idCompte);
		//echo $req;
		//insert inscription
		
		$msg= "Inscription effectu&eacute;e en succ&egrave;s";} else 
...
?><center>
	...
	<table border=0>
    <tr class="tmessage"><td colspan=2 align="center"><?php echo $msg;?></td></tr><tr><td>Login: </td><td><input type="text" name="login" size="70"></td></tr>
    <tr><td>Mot de passe : </td><td><input type="password" name="pass" size="70"></td></tr>
	<tr><td>Confirmation : </td><td><input type="password" name="passe" size="70"></td></tr>
    <tr><td></td></tr>
